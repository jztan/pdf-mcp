...
`0.8.0` pinned), so the numbers are reproducible.
...
| keyword | 0.642 |
| semantic | 0.656 |
| **auto (hybrid RRF)** | **0.777** |

Hybrid beats keyword-only by **+13.5pp** and semantic-only by **+12.1pp**. This
...
| --- | --- | --- | --- | --- |
| stemming | 9 | 0.626 | 0.680 | **0.762** |
| substring | 10 | **0.893** | 0.617 | 0.864 |
| fusion | 4 | 0.385 | 0.728 | **0.774** |
| distractor | 5 | 0.372 | 0.632 | **0.634** |
| **all** | 28 | 0.642 | 0.656 | **0.777** |
...
- **Honest caveat — substring is the exception.** On substring queries, plain
  `keyword` (0.893) edges out `hybrid` (0.864): BM25 already nails these, and RRF
