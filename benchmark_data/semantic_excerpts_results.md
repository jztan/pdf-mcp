...
Generated 2026-09-06T05:57:50+00:00 at `ee94871` by `scripts/benchmark_semantic_excerpts.py`. Both arms run `mode="semantic"`; corpus scores span recall of the gold evidence within 2,000 tokens (top_k=25), single-doc scores answer containment in the graded page's excerpt (max_results=5).
...
|---|---|---|---|---|---|---|
| snippet | 0.537 (n=82) | 0.809 (n=21) | 0.667 (n=9) | 0.404 (n=52) | graded page hit 74 | 1.82 |
| paragraph | 0.744 (n=82) | 0.905 (n=21) | 0.889 (n=9) | 0.654 (n=52) | graded page hit 74 | 0.30 |
...
Queries with a different excerpt: corpus/snippet: 8/184, corpus/paragraph: 2/184, single/snippet: 1/82, single/paragraph: 0/82
